 ...
 */
contract DeployWeightedPool8020WithCheckHook is PoolHelpers, ScaffoldHelpers {
    function deployWeightedPool8020WithCheckHook(address token1, address token2) internal {
